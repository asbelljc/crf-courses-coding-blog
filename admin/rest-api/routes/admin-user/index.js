...
const { authAdminUser } = require('../../middlewares');
...
router.put('/users/logout', authAdminUser, function (req, res) {
...
router.put('/users/remove-admin-user-cookie', function (req, res) {
...
router.put('/users/change-password', authAdminUser, function (req, res) {
